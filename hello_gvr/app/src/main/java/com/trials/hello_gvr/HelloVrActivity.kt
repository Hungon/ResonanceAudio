 ...
 *
 *
 * This app presents a scene consisting of a room and a floating object. When the user finds the
 ...
 */
class HelloVrActivity : GvrActivity(), GvrView.StereoRenderer {
     ...
     */
    private// Convert object space to camera space. Use the headView from onNewFrame.
